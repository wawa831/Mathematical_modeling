        ...
        for bus in buses:
            ...
            for start, end in route_edges:
                ...
                if (start, end) in travel_times:
                    ...
                    congestion_factor = 1.2 if total_time < 60 else 1.0  # 早高峰前 60 分钟拥堵系数为 1.2
                    travel_time = (distance / (speed / congestion_factor)) * 60  # 转换为分钟
                ...
                if remaining_passengers[start]:
                    ...
                    ) * random.uniform(2, 4) / 60  # 上下车时间在 2 - 4 秒之间随机取值
